...
class TextLabelSeeder extends Seeder
{
   ...
   fost actualizat. Te rugam să verifici coșul înainte de a plasa comanda.', 'description' => 'Cart changed mesage - div', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ...
            ['parameter' => 'cart_page_quantity_error', 'value' => 'Stoc disponibil pentru acest produs:', 'description' => 'Cart quantity error - span', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ['parameter' => 'cart_page_quantity_tag', 'value' => 'Cantitatea', 'description' => 'Cart page quantity tag - span', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
