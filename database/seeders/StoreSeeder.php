...
Capital Social: 200 RON', 'description' => 'Invoide serias', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ...
            ['parameter' => 'min_limit_similarity', 'value' => '50', 'description' => 'Min limiti of order similarity', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ...
            ['parameter' => 'ckeditor_license', 'value' => 'pref', 'description' => 'ckeditor_license', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ['parameter' => 'header_display_blog', 'value' => '', 'description' => 'Display Blog page on header', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ...
            ['parameter' => 'articles_limit_load', 'value' => '5', 'description' => 'Limit Load articles', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ...
            ['parameter' => 'review_pagination', 'value' => 'links', 'description' => 'Pagination type, accepted: lazy/links', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ['parameter' => 'review_limit_load', 'value' => '8', 'description' => 'Limit Load review', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ['parameter' => 'order_similarity_limit', 'value' => '5', 'description' => 'Limit select order to process', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ['parameter' => 'telegram_notification', 'value' => 'false', 'description' => 'Telegram Notification', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ['parameter' => 'telegram_bot_api', 'value' => '', 'description' => 'telegram bot api', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
            ['parameter' => 'telegram_channel', 'value' => '', 'description' => 'telegram channel', 'createdby' => 'admin', 'lastmodifiedby' => 'admin', 'created_at' => $currentTime, 'updated_at' => $currentTime],
