...
class ShowSupplier extends Component
{
  ...
  public function edititem()
  {
    ...
    $this->record = [
      ...
      'currency' => $this->supplier->currency ?? null,
      'quote_currency' => $this->supplier->quote_currency ?? null,
    ];
    $this->edititem = true;
    $this->rate['itemselected'] = $this->supplier->exchange ? $this->supplier->exchange->base_currency->name . '/' . $this->supplier->exchange->quote_currency->name . ' date - ' . $this->supplier->exchange->date . ' value - ' . $this->supplier->exchange->value : null;
    $this->rate['idrel'] = $this->supplier->exchange_id ?? null;
  }
