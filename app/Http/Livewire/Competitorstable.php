...
class Competitorstable extends Component
{
  ...
  public function render()
  {
    ...
    return view('livewire.competitorstable', [
  ...
  {
    return $this->competitorsQuery->paginate($this->loadAmount);
  }

  public function getCompetitorsQueryProperty()
  {
    $query = Competitor::search($this->search);
  ...
  {
    if ($value) {
      $this->checked = $this->competitors->pluck('id')->map(fn($item) => (string) $item)->toArray();
    } else {
      $this->checked = [];
    }
  }
  ...
  {
    $this->selectAll = true;
    $this->checked = $this->competitorsQuery->pluck('id')->map(fn($item) => (string) $item)->toArray();
  }
  ...
  {
    $items = Competitor::whereKey($this->checked)->get();
  ...
  public function exportData()
  {
    ...
    return Response::streamDownload(function () use ($selectedColumns, $checked) {
      ...
      $query = $this->getCompetitorsQueryProperty();
