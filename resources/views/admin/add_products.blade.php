                            ...
                            <div class="col-12-xs col-12-sm col-4-xl text-bg">
                                <ul>
                                    ...
                                    <li class="p-1 listelement">
                                        <div class="container_img bg-bg-light-9 br-xs" style="background: red
                                        ">
                                    ...
                                    <li class="p-1 listelement">
                                        {{-- <div class="container_img_multiple bg-bg-light-9 br-xs">
                                            ...
                                            <div class="talign-c">
                                                <label for="upload-button-multiple" class="br-xs cursor-p">
                                                    <svg width="64px" height="64px" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                ...
                                                <p class="font-md mt-1 display-b" id="num-of-files">
                                                    {{ __('No files Chosen') }}</p>
                                            </div>
                                        </div> --}}
                                    </li>
                                </ul>
