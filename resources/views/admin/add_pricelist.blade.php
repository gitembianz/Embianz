...
<form class="content" method="POST" action="{{ route('add_pricelist') }}">
  ...
  <nav class="nav--controls">
    <h1 class="table--name">Add new price list</h1>
    {{-- Refresh Button --}}
    <a class="button button--secondary button--centered" tooltip="Back to Price Lists" tooltip-top href="{{ route('pricelists') }}">
      <svg><polyline points="15 18 9 12 15 6"></polyline></svg>
    </a>
    <button class="button button--secondary button--centered" tooltip="Save Price" tooltip-left type="submit">
    ...
    <button class="button button--secondary button--centered" tooltip="Reset Price" tooltip-left type="reset">
