...
<form class="content" method="POST" action="{{ route('store_page') }}">
    ...
    <nav class="nav--controls">
        ...
        {{-- Refresh Button --}}
        <a class="button button--primary button--centered" tooltip="Back to pages lists" tooltip-top
            href="{{ route('pages') }}">
            <svg>
    ...
    <section style="height: calc(100% - 107.5px);" class="tabs__content details__view active">
        ...
        <div class="details__checkboxes">
            ...
            <div class="checkbox__details ">
                <input type="checkbox" id="display_in_footer" name="display_in_footer" value="{{ old('display_in_footer') }}">
                <label for="display_in_footer">Display in footer</label>
            </div>
        </div>
