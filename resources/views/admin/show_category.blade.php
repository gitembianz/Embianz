...
<section class="section-container bg-sidebar-bg-light-1">
    ...
    <div class="row gap-4 mt-2 mb-2 justify-center talign-c">
        <div class="col-12-xs display-c col-12-sm col-12-xl m-1 text-white">
            ...
            <input type="button" onclick="event.preventDefault();location.href='/category'"
                class="cursor-p ls-1 br-xs p-1 text-secondary bg-hover-bg bg-sidebar-bg-light-1" value="Back"
                id="back">
        </div>
    </div>
            ...
            <div class="col-12-xs col-12-sm mt-1 col-5-xl text-white">
                <ul class="p-1">
                    <li class="listelement p-1">
                        ...
                        <span class="ml-1 font-lg talign-c text-secondary p-1 bg-bg"
                ...
                <div class="col-12-xs col-12-sm col-12-xl m-1 text-white">
                    <ul>
                        <li><input type="button"
                                ...
                                class="cursor-p br-xs font-lg ls-1 talign-c p-1 text-secondary bg-hover-bg bg-sidebar-bg-light-1"
                                value="Add New" id="new">
                            <input type="button"
                                class="edit br-xs font-lg ls-1 text-secondary ml-1 cursor-p p-1 bg-hover-bg bg-sidebar-bg-light-1"
                            ...
                            <input type="button"
                                class="delete ml-1 font-lg text-secondary br-xs ls-1 cursor-p p-1 bg-hover-bg bg-sidebar-bg-light-1"
