                ...
                <ul>
                    ...
                    <li class="listelement p-1">
                        ...
                        <div class="container_img bg-bg-light-9 br-xs">
                            ...
                            <img id="chosen-image" src="/categories/{{ $data->image->first()->img_main_path }}"
                                alt="category_image_main" width="100" height="50">
                        ...
                        @endif
                            ...
                            <input type="file" name="category_image_main" id="upload-button" accept="image/*">
                            <div class="display-f">
                    ...
                    <li class="listelement p-1">
                        ...
                        <div class="container_img bg-bg-light-9 br-xs">
                            ...
                            <img id="chosen-image-search" src="/categories/{{ $data->image->first()->img_search_path }}"
                                alt="category_image_search" width="100" height="50">
                    ...
                    <li class="listelement p-1">
                        ...
                        <div class="subelement display-g">
                            ...
                            <span class="mboxsha font-lg talign-c text-bg p-1 br-xs bg-bg-light-9"
                                id="category_image_sequence">{{ $data->image->first()->img_sequence }}</span>
                        @else
