...
<form class="content" method="POST" enctype="multipart/form-data" action="{{ route('add_category') }}">
 ...
 <nav class="nav--controls">
  ...
  {{-- Refresh Button --}}
  <a class="button button--secondary button--centered" tooltip="Back to Categories" tooltip-top
   href="{{ route('category') }}">
   <svg>
    <polyline points="15 18 9 12 15 6"></polyline>
   </svg>
  </a>
  <button class="button button--secondary button--centered" tooltip="Save Category" tooltip-left type="submit">
   <svg>
  ...
  <button class="button button--secondary button--centered" tooltip="Reset Category" tooltip-left type="reset">
   <svg>
    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
