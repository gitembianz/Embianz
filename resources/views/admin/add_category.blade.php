                ...
                <li class="p-1 font-xl">
                    <form action="{{ url('/add_category') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row add_header col-12-xs col-12-sm col-12-xl jus-sb display-f">
                            <h1 id="title" class="ml-1 fw-500 ls-3 text-bg">{{ __('Create Category') }}</h1>
                                ...
                                <ul>
                                    ...
                                    <li class="p-1 listelement">
                                        <div class="container_img bg-bg-light-9 br-xs">
                                            ...
                                            <input type="file" name="category_image" id="upload-button"
                                                accept="image/*">
                                            <div class="display-f">
                                                <label for="upload-button" class="br-xs cursor-p">
                                                ...
                                                <input type="button" class="browse1 ml-1 br-xs talign-c cursor-p" value="or Browse" name="browse" id="browse_main">
                                    ...
                                    <li class="p-1 listelement">
                                        <div class="container_img bg-bg-light-9 br-xs">
                                            ...
                                            <input type="file" name="category_image_search" id="upload-button-search" accept="image/*">
                                            <div class="display-f">
                                                <label for="upload-button-search" class="br-xs cursor-p"><svg
                                                ...
                                                <input type="button" class="browse1 ls-1 ml-1 br-xs talign-c cursor-p bg-white" value="or Browse" name="browse" id="browse_search">
                                    ...
                                    <li class="p-1 listelement">
                                        <div class="subelement100 display-g">
                                            ...
                                            <input type="number" class="p-1 subelement100" name="image_sequence" placeholder="Image sequence">
                                        </div>
                                    </li>
                                    <li class="p-1 listelement">
