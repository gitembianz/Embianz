...
<section class="section-container">
    ...
    <div class="row mt-1 bg-white br-sm">
        {{-- page title --}}
            ...
            <li class="p-1 font-xl">
                <form action="{{ url('/add_category') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12-xs col-12-sm col-12-xl display-f">
                            <h1 id="title" class="talign-l font-xl ml-2 ls-1 text-bg">{{ __('Create Category') }}
                            </h1>
                    ...
                    <div class="row gap-2 justify-center">
                        <div class="col-12-xs col-12-sm mt-1 col-5-xl text-bg">
                            <ul class="pt-1">
                                <li class="p-1 listelement">
                                    <label class="font-lg text-bg ls-1">Name -</label>
                                    <input type="text" name="category" placeholder="Enter a category name"
                                        required>
                                </li>
                                <li class="p-1 listelement">
                                    <label class="font-lg text-bg ls-1">Parent -</label>
                        ...
                        <div class="col-12-xs col-12-sm mt-1 col-5-xl text-bg">
                            <ul>
                                ...
                                <li class="p-1 listelement">
                                    <label class="font-lg text-bg ls-1">Start Date -</label>
                                ...
                                <li class="p-1 listelement">
                                    ...
                                    <label class="font-lg text-bg ls-1">Image Sequence -</label>
                        ...
                        <div class="col-12-xs col-12-sm mt-1 col-8-xl text-bg">
                            <ul>
                                <li class="p-1 listelement">
                                    ...
                                    <input type="button"
                                        class="browse1 ls-1 ml-1 talign-c cursor-p bg-white"
