...
<form class="content" method="POST" action="{{ route('add_variant') }}">
 ...
 <nav class="nav--controls">
  ...
  {{-- Refresh Button --}}
  <a class="button button--secondary button--centered" tooltip="Back to Variants" tooltip-top
   href="{{ route('variants') }}">
   <svg>
    <polyline points="15 18 9 12 15 6"></polyline>
   </svg>
  </a>
  <button class="button button--secondary button--centered" tooltip="Save variant" tooltip-left type="submit">
   <svg>
  ...
  <button class="button button--secondary button--centered" tooltip="Reset form" tooltip-left type="reset">
   <svg>
    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
