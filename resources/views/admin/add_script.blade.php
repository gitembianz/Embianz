...
<form class="content" method="POST" enctype="multipart/form-data" action="{{ route('add_script') }}">
  ...
  <nav class="nav--controls">
    ...
    {{-- Refresh Button --}}
    <a class="button button--secondary button--centered" tooltip="Back to Custom codes" tooltip-top href="{{ route('customscripts') }}">
      <svg><polyline points="15 18 9 12 15 6"></polyline></svg>
    </a>
    <button class="button button--secondary button--centered" tooltip="Save Code" tooltip-left type="submit">
    ...
    <button class="button button--secondary button--centered" tooltip="Reset Code" tooltip-left type="reset">
