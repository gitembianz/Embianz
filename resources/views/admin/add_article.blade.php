...
<form class="content" method="POST" enctype="multipart/form-data" action="{{ route('store_article') }}">

    {{-- Navigation --}}
    <nav class="nav--controls">
        <h1 class="table--name">New Article</h1>
        {{-- Refresh Button --}}
        <a class="button button--primary button--centered" tooltip="Back to articles" tooltip-top
            href="{{ route('articles') }}">
            <svg>
