{{-- <header>
    <div class="header__top">
        <div class="container header__top--flex">
            ...
            <a href="{{ url('/storeproducts') }}"><button>Store</button></a>
        </div>
    </div>
        ...
        <div class="container header">
            ...
            <nav class="menu sidebar" id="menu">
                <ul class="menu__list sidebar__content container" id="menuContent">
                        ...
                        <ul class="menu__sub">
                            <div class="menu__sub--wrapper">
                                <div class="menu__sub--list">
                                    <a class="menu__sub--item">Sticle</a>
                                    <a class="menu__sub--item">Sticle Termice</a>
                                    <a class="menu__sub--item">Sticle Pentru Copii</a>
                                </div>
                            </div>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="menu__sub">
                            <div class="menu__sub--wrapper">
                                <div class="menu__sub--list">
                                    <a class="menu__sub--item">Sticle Termice</a>
                                    <a class="menu__sub--item">Cutii De Pranz</a>
                                    <a class="menu__sub--item">Cani Termice</a>
                                    <a class="menu__sub--item">Sticle Pentru Copii</a>
                                    <a class="menu__sub--item">Accesorii</a>
                                </div>
                            </div>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a class="menu__link">Accesorii</a>
                    </li>
                </ul>
            </nav>
            <div class="header__buttons">
                ...
                <div class="cart">
                    ...
                    <ul class="cart__list" id="cartContent">
                        ...
                        <li><a class="cart__list--item" href="#">
                                <img class="cart__list--img" src="images/store/background-bottle1.jpeg"
                                    alt="Sustainable Sips: Reusable Bottles">
                                <span class="cart__list--text">Sustainable Sips: Reusable Bottles</span>
                                <span class="cart__list--much">x5</span>
                                <span class="cart__list--much">40$</span>
