<main>
 ...
 <aside id="menu__container" class="display--mobile">
  ...
  <div class="aside aside--left" wire:ignore id="menu">
   ...
   <a
    class="button button--fill button--flexed button--primary @if ($active == 'pages') button--active @endif"
    href="{{ route('pages') }}">
    ...
    <span>Static pages</span>
      ...
      <a
    class="button button--fill button--flexed button--primary @if ($active == 'user') button--active @endif"
    href="{{ route('users') }}">
 ...
 <div class="leftbar display--desktop active" id="leftbar">
  ...
  <a
   class="button button--long button--flexed button--primary @if ($active == 'pages') button--secondary @endif"
   href="{{ route('pages') }}">
   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    class="feather feather-file-text">
  ...
  <a
   class="button button--long button--flexed button--primary @if ($active == 'user') button--secondary @endif"
   href="{{ route('users') }}">
  <svg><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
   <span>Users</span>
  </a>
