<main>
	<div class="sidebar">
		...
		<ul class="sidebar__list">
			...
			<li class="dropdown">
				<a class="sidebar__item @if ($active == "store_settings" || $active == "payment") active @endif dropdown-button" href="#" style="z-index: 99999;">
					<button class="sidebar__icon">
						<svg>
				...
				<div class="dropdown-list" style="width: 100%;margin-top: -10px;border-radius: 10px;padding: 20px 0 10px 20px;border: none;background: #35424b;">
