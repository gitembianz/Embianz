<header>
	...
	<nav class="nav--header">
		<button class="button button--primary button--centered display--mobile" tooltip="Open Menu" tooltip-right id="menu__open">
			<svg>
		...
		<button class="button button--primary button--centered" tooltip="Open Searchbar" tooltip-bottom onclick="focusTo('search__input')" id="search__open">
			<svg>
