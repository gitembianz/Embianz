<header>
	...
	<nav class="nav--header">
		<button class="button button--secondary button--centered display--mobile" tooltip="Open Menu" tooltip-right id="menu__open">
			<svg>
		...
		<button class="button button--secondary button--centered" tooltip="Open Searchbar" tooltip-bottom onclick="focusTo('search__input')" id="search__open">
			<svg>
    ...
    <a href="{{ route("dashboard") }}" class="logo display--mobile">
		...
		<button class="button button--secondary button--centered" tooltip="Open Notifications" tooltip-left id="notify__open">
			<svg>
				<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
				<path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
			</svg>
		</button>
		<button class="button button--secondary button--centered" tooltip="Open Profile" tooltip-left id="profile__open">
			<svg>
