...
<main>
    <div class="cart__page container">
        ...
        <div class="cart-page__list">
            <article class="cart-page__item">
                <img src="/images/store/bottle2.webp" alt="bottle number 1">
    ...
    <div class="support">
        <div class="support__container container">
            <h4>La noi te bucuri de:</h4>
            <div class="support__bundle">
                <div class="support__item">
                    ...
                    <div class="support__item--text">
                        <p>24/7 Suport Disponibil</p>
                        <span>Operatorii nostri sunt gata sa-ti raspunda</span>
                    </div>
                </div>
                <div class="support__item">
                    <svg viewBox="0 -1 26 26" stroke-width="0" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="support__item--text">
                        <p>Livrare gratis de la 250 lei</p>
                        <span>pentru produsele vandute de ecosticle.ro</span>
                    </div>
                </div>
                <div class="support__item">
                    <svg fill="#000000" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id="lock-check"
                        class="icon glyph">
                        <path
                    ...
                    <div class="support__item--text">
                        <p>Comenzi si plati 100% sigure</p>
                        <span>Toate datele sunt transmise securizat</span>
                    </div>
                </div>
            </div>
            <h4>Poti afla mai multe:</h4>
            <ul class="support__list">
                <li>
                    <a class="support__list-item" href="#">Modalitate de plata</a>
                </li>
                <li>
                    <a class="support__list-item" href="#">Modalitate de livrare</a>
                </li>
                <li>
                    <a class="support__list-item" href="#">Politica de utilizare Cookie-uri</a>
                </li>
                <li>
                    <a class="support__list-item" href="#">Termeni si conditii</a>
                </li>
            </ul>
        </div>
    </div>
