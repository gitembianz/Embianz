<section class="content">
                    ...
                    <div class="input__tabs details__long">
                        <select wire:model.defer="pickup_point">
                            @foreach ($addresses as $address)
                                <option style="max-width: 100% !important" value="{{ $address['id'] }}">
                                    {{ $address['alias'] }},
    ...
    <nav class="nav--controls">
        ...
        <button class="button button--primary button--centered" tooltip="Generate tokens for awb" tooltip-top
            wire:click="generate_tokens()">
            <svg>
                <path
        ...
        <div class="dropdown dropdown--right">
            ...
            <button class="button button--primary  button--centered button--long dropdown__button"
                tooltip="Generate awb" tooltip-top>
                <span>Generate AWB</span>
            </button>
