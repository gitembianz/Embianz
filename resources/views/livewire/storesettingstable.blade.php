<div class="content">
  ...
  {{-- Navigation --}}
  <h1 class="table--name">{{ __('Store Settings') }} ({{ $storesettings->count() }})</h1>
  <nav class="nav--controls">
    ...
    <button class="button button--secondary button--centered display--desktop" wire:click="sitemap">
      <svg>
        ...
        <path d="M19 15v6h3" /><path d="M11 21v-6l2.5 3l2.5 -3v6" />
      </svg>
    </button>
    {{-- Sorting Dropdown --}}
      ...
      <tbody>
        ...
        @foreach ($storesettings as $index => $store)
          <tr class="expandable-row">
            ...
            <td>
              @if ($indexstoresettings !== $index)
              <button class="button button--secondary button--sm" wire:click.prevent="edititem({{ $index }}, {{ $store->id }})">
                <svg>
              ...
              @else
                <div style="display: flex;">
                  <button class="button button--secondary button--sm" wire:click.prevent="saveitem({{ $index }} , {{ $store->id }})">
                    <svg>
                    <polyline points="20 6 9 17 4 12"></polyline>
                    </svg>
                  </button>
