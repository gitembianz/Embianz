<div>
	...
	<div class="panel__header">
		...
		<input class="panel__header--input" type="text" wire:model.debounce.300ms="search" placeholder="Search your price field...">
			...
			<tr>
				...
				@if ($this->showColumn("Parameter"))
					<th wire:click="sortBy('parameter')">
						<button class="table__header--btn" @if ($orderBy === "parameter" && $orderAsc === "1") data-symbol="up" @else
				...
				@if ($this->showColumn("Value"))
					<th wire:click="sortBy('value')">
						<button class="table__header--btn" @if ($orderBy === "value" && $orderAsc === "1") data-symbol="up" @else
                            data-symbol="down" @endif>
							Value
							<svg>
								<line x1="12" y1="5" x2="12" y2="19"></line>
				...
				@if ($this->showColumn("Description"))
					<th wire:click="sortBy('description')">
						<button class="table__header--btn" @if ($orderBy === "description" && $orderAsc === "1") data-symbol="up" @else
                            data-symbol="down" @endif>
							Description
							<svg>
								<line x1="12" y1="5" x2="12" y2="19"></line>
				...
				@if ($this->showColumn("Updated At"))
					<th wire:click="sortBy('updated_at')">
						<button class="table__header--btn" @if ($orderBy === "updated_at" && $orderAsc === "1") data-symbol="up"
                          @else data-symbol="down" @endif>
							Updated at
							<svg>
								<line x1="12" y1="5" x2="12" y2="19"></line>
