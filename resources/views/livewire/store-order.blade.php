        ...
        <div class="checkout container">
            ...
            <div class="checkout__header">
                ...
                <div class="checkout__navigation">
                    ...
                    <button class="checkout__button checkout__button--confirm" @if ($individual && $individual_identic)
                        onclick="validateIndividual(this)" @elseif ($individual && !$individual_identic)
                        onclick="validateIndividualIdentic(this)" @elseif($juridic && $juridic_identic)
                        onclick="validateJuridic(this)" @else onclick="validateJuridicIdentic(this)" @endif
            ...
            <div class="checkout__container @if ($individual) active @endif">
                <div wire:ignore class="checkout__form active">
                    ...
                    <div class="checkout__item checkout__item--required" id="individualShippingFirstNameParent">
                        <input type="text" wire:model.defer="individual_billing_first"
                            name="individualShippingFirstName"
                ...
                <div wire:ignore class="checkout__form active">
                    ...
                    <div class="checkout__item checkout__item--required" id="individualShippingAddressParent">
                        <input type="text" wire:model.defer="individual_billing_address1"
                            name="individualShippingAddress"
                    ...
                    <div class="checkout__item checkout__item--required" id="individualShippingPostalParent">
                        <input type="text" wire:model.defer="individual_billing_zipcode" name="individualShippingPostal"
                            ...
                            autocomplete="postal-code" required id="individualShippingPostal">
                        <span></span>
                ...
                <div class="checkout__form @if (!$individual_identic && $individual) active @endif">
                    ...
                    <div wire:ignore class="checkout__item checkout__item--required"
                        id="individualBillingFirstNameParent">
                        <input type="text" wire:model.defer="individual_shipping_first"
                            name="individualBillingFirstName"
                            placeholder="@if (app()->has('label_order_firstname')) {!! app('label_order_firstname') !!} @endif"
                    ...
                    <!---------------------------------------------------->
                    <div wire:ignore class="checkout__item checkout__item--required"
                        id="individualBillingLastNameParent">
                ...
                <div class="checkout__form @if (!$individual_identic && $individual) active @endif">
                    ...
                    <select wire:ignore wire:model="individual_shipping_country" class="select"
                        id="individual_shipping_country" aria-label="select a country">
                        <option value="Afghanistan">Afghanistan</option>
                        <option value="Åland Islands">Åland Islands</option>
                        <option value="Albania">Albania</option>
                        <option value="Algeria">Algeria</option>
                    ...
                    <div wire:ignore class="checkout__item checkout__item--required" id="individualBillingCityParent">
                        <input type="text" wire:model.defer="individual_shipping_city" name="individualBillingCity"
                            placeholder="@if (app()->has('label_order_city')) {!! app('label_order_city') !!} @endif"
                            autocomplete="off" required id="individualBillingCity">
                        <span></span>
                    ...
                    <div wire:ignore class="checkout__item checkout__item--required" id="individualBillingPostalParent">
                        <input type="text" wire:model.defer="individual_shipping_zipcode" name="individualBillingPostal"
                            placeholder="@if (app()->has('label_order_zipcode')) {!! app('label_order_zipcode') !!} @endif"
                            autocomplete="postal-code" required id="individualBillingPostal">
                        <span></span>
                ...
                <div wire:ignore class="checkout__form active">
                    ...
                    <div class="checkout__item checkout__item--required" id="juridicShippingPhoneParent">
                        <input type="tel" wire:model.defer="juridic_billing_phone" name="juridicShippingPhone"
                            placeholder="@if (app()->has('label_order_phone')) {!! app('label_order_phone') !!} @endif"
                            autocomplete="tel" pattern="[0-9]*" inputmode="numeric" required id="juridicShippingPhone">
                        <span></span>
                ...
                <div class="checkout__form @if (!$juridic_identic && $juridic) active @endif">
                    ...
                    <div wire:ignore class="checkout__item checkout__item--required" id="juridicBillingPhoneParent">
                        <input type="tel" wire:model.defer="juridic_shipping_phone" name="juridicBillingPhone"
                            placeholder="@if (app()->has('label_order_phone')) {!! app('label_order_phone') !!} @endif"
                            autocomplete="tel" pattern="[0-9]*" inputmode="numeric" required id="juridicBillingPhone">
                        <span></span>
                        ...
                        $cartItem->product->quantity < $cartItem->quantity &&
                            ...
                            <div class="total__item">
                                ...
                                <span>
                                    ...
                                    @endif
                                    @else
                                    {{ number_format($cart->delivery_price, 2, $decimal, $mill) }} @if
                                    (app()->has('global_currency_primary_symbol'))
                                    {!! app('global_currency_primary_symbol') !!}
                                    @endif
                                    @endif
                                </span>
                            ...
                            <div class="total__item">
                                ...
                                <span>
                                    -{{ number_format($cart->voucher_value, 2, $decimal, $mill) }} @if
                                    (app()->has('global_currency_primary_symbol'))
                                    {!! app('global_currency_primary_symbol') !!}
                                    @endif
                                </span>
                            ...
                            <div class="total__item">
                                ...
                                <span>{{ number_format($cart->final_amount, 2, $decimal, $mill) }} @if
                                    (app()->has('global_currency_primary_symbol'))
                                    {!! app('global_currency_primary_symbol') !!}
                                    @endif
                                </span>
            ...
            <div class="total__container">
                ...
                <div class="look__form">
                    ...
                    <span class="total__message">
                        ...
                        {!! app('label_order_fullname') !!}
                        @endif:
                        <strong>{{ $new_order->account->addresses->where('type', 'billing')->first()->first_name
                            }}</strong>
                        <strong>{{ $new_order->account->addresses->where('type', 'billing')->first()->last_name
                            }}</strong>
                    </span>
                    <span class="total__message">
                        @if (app()->has('label_order_phone'))
                    ...
                    <span class="total__message">
                        ...
                        {!! app('label_order_address1') !!}
                        @endif:
                        <strong>{{ $new_order->account->addresses->where('type', 'billing')->first()->address1
                            }}</strong>
                        <strong>{{ $new_order->account->addresses->where('type', 'billing')->first()->address2
                            }}</strong>
                    </span>
                    <span class="total__message">
                        @if (app()->has('label_order_country'))
                        {!! app('label_order_country') !!}
                        @endif:
                        <strong>{{ $new_order->account->addresses->where('type', 'billing')->first()->country
                            }}</strong>
                    </span>
                    <span class="total__message">
                        @if (app()->has('label_order_county'))
                    ...
                    <span class="total__message">
                        ...
                        {!! app('label_order_zipcode') !!}
                        @endif:
                        <strong>{{ $new_order->account->addresses->where('type', 'billing')->first()->zipcode
                            }}</strong>
                    </span>
                    ...
                    <span class="total__message">
                        ...
                        {!! app('label_order_fullname') !!}
                        @endif:
                        <strong>{{ $new_order->account->addresses->where('type', 'shipping')->first()->first_name
                            }}</strong>
                        <strong>{{ $new_order->account->addresses->where('type', 'shipping')->first()->last_name
                            }}</strong>
                    </span>
                    <span class="total__message">
                        @if (app()->has('label_order_phone'))
                    ...
                    <span class="total__message">
                        ...
                        {!! app('label_order_address1') !!}
                        @endif:
                        <strong>{{ $new_order->account->addresses->where('type', 'shipping')->first()->address1
                            }}</strong>
                        <strong>{{ $new_order->account->addresses->where('type', 'shipping')->first()->address2
                            }}</strong>
                    </span>
                    <span class="total__message">
                        @if (app()->has('label_order_county'))
                        {!! app('label_order_county') !!}
                        @endif:
                        <strong>{{ $new_order->account->addresses->where('type', 'shipping')->first()->country
                            }}</strong>
                    </span>
                    <span class="total__message">
                        @if (app()->has('label_order_county'))
                        {!! app('label_order_county') !!}
                        @endif:
                        <strong>{{ $new_order->account->addresses->where('type', 'shipping')->first()->county
                            }}</strong>
                    </span>
                    <span class="total__message">
                        @if (app()->has('label_order_city'))
                    ...
                    <span class="total__message">
                        ...
                        {!! app('label_order_zipcode') !!}
                        @endif:
                        <strong>{{ $new_order->account->addresses->where('type', 'shipping')->first()->zipcode
                            }}</strong>
                    </span>
                </div>
                <!----------------------- Order sumary ----------------------------->
                <div class="total__info">
                    ...
                    <div class="total__item">
                        ...
                        <span>
                            ...
                            @endif
                            @else
                            {{ number_format($new_order->delivery_price, 2, $decimal, $mill) }} @if
                            (app()->has('global_currency_primary_symbol'))
                            {!! app('global_currency_primary_symbol') !!}
                            @endif
                            @endif
            ...
            <div class="checkout__header" style="flex-direction: row !important">
                ...
                @endif
                @elseif ($step == 1)
                <button class="checkout__link checkout__button--confirm" @if ($individual && $individual_identic)
                    onclick="validateIndividual(this)" @elseif ($individual && !$individual_identic)
                    onclick="validateIndividualIdentic(this)" @elseif($juridic && $juridic_identic)
                    onclick="validateJuridic(this)" @else onclick="validateJuridicIdentic(this)" @endif
