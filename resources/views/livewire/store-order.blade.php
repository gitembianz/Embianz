				...
				@if ($step == 1)
					...
					<div class="checkout__container @if ($individual) active @endif">
						...
						<div wire:ignore class="checkout__form active">
							...
							<div class="checkout__item checkout__item--required" id="individualShippingCityParent">
								<input type="text" wire:model.defer="individual_billing_city" name="individualShippingCity" placeholder="@if (app()->has('label_order_city')){!! app('label_order_city') !!} @endif" autocomplete="city" required id="individualShippingCity">
								<span></span>
							...
							<div class="checkout__item checkout__item--required" id="individualShippingPostalParent">
								<input type="text" wire:model.defer="individual_billing_zipcode" name="individualShippingPostal" placeholder="@if (app()->has('label_order_zipcode')){!! app('label_order_zipcode') !!} @endif" autocomplete="postal-code" required id="individualShippingPostal">
								<span></span>
						...
						<div class="checkout__form @if (!$individual_identic && $individual) active @endif">
							...
							<div wire:ignore class="checkout__item checkout__item--required" id="individualBillingPhoneParent">
								<input type="tel" wire:model.defer="individual_shipping_phone" name="individualBillingPhone" placeholder="@if (app()->has('label_order_phone')){!! app('label_order_phone') !!} @endif" autocomplete="tel" pattern="[0-9]*" inputmode="numeric" required id="individualBillingPhone">
								<span></span>
								<label for="individualBillingPhone">@if (app()->has('label_order_phone')){!! app('label_order_phone') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div wire:ignore class="checkout__item checkout__item--required" id="individualBillingEmailParent">
								<input type="email" wire:model="individual_shipping_email" name="individualBillingEmail" placeholder="@if (app()->has('label_order_email')){!! app('label_order_email') !!} @endif" autocomplete="email" required id="individualBillingEmail">
								<span></span>
								<label for="individualBillingEmail">@if (app()->has('label_order_email')){!! app('label_order_email') !!} @endif</label>
							</div>
						</div>
						<div class="checkout__form @if (!$individual_identic && $individual) active @endif">
							<div class="checkout__top">
								<span>4</span>
								<h3>@if (app()->has('label_order_shipping_address')){!! app('label_order_shipping_address') !!} @endif</h3>
							</div>
							<div wire:ignore class="checkout__item checkout__item--required" id="individualBillingAddressParent">
								<input type="text" wire:model.defer="individual_shipping_address1" name="individualBillingAddress" placeholder="@if (app()->has('label_order_address1')){!! app('label_order_address1') !!} @endif" autocomplete="street-address" required id="individualBillingAddress">
								<span></span>
								<label for="individualBillingAddress">@if (app()->has('label_order_address1')){!! app('label_order_address1') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div wire:ignore class="checkout__item" id="individualBillingAddress2Parent">
								<input type="text" wire:model.defer="individual_shipping_address2" name="individualBillingAddress2" placeholder="@if (app()->has('label_order_address2')){!! app('label_order_address2') !!} @endif" autocomplete="address-level2" id="individualBillingAddress2">
								<span></span>
								<label for="individualBillingAddress2">@if (app()->has('label_order_address2')){!! app('label_order_address2') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							...
							<div wire:ignore class="checkout__item checkout__item--required" id="individualBillingCountyParent">
								<input type="text" wire:model.defer="individual_shipping_county" name="individualBillingCounty" placeholder="@if (app()->has('label_order_county')){!! app('label_order_county') !!} @endif" autocomplete="county" required id="individualBillingCounty">
								<span></span>
								<label for="individualBillingCounty">@if (app()->has('label_order_county')){!! app('label_order_county') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div wire:ignore class="checkout__item checkout__item--required" id="individualBillingCityParent">
								<input type="text" wire:model.defer="individual_shipping_city" name="individualBillingCity" placeholder="@if (app()->has('label_order_city')){!! app('label_order_city') !!} @endif" autocomplete="off" required id="individualBillingCity">
								<span></span>
								<label for="individualBillingCity">@if (app()->has('label_order_city')){!! app('label_order_city') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div wire:ignore class="checkout__item checkout__item--required" id="individualBillingPostalParent">
								<input type="text" wire:model.defer="individual_shipping_zipcode" name="individualBillingPostal" placeholder="@if (app()->has('label_order_zipcode')){!! app('label_order_zipcode') !!} @endif" autocomplete="postal-code" required id="individualBillingPostal">
								<span></span>
								<label for="individualBillingPostal">@if (app()->has('label_order_zipcode')){!! app('label_order_zipcode') !!} @endif</label>
							</div>
						</div>
					</div>
						<!-------------- Juridic -------------->
					<div class="checkout__container @if ($juridic) active @endif">
						<div wire:ignore class="checkout__form active">
							<div class="checkout__top">
								<span>1</span>
								<h3>@if (app()->has('label_order_billing_info_juridic')){!! app('label_order_billing_info_juridic') !!} @endif</h3>
							</div>
							<div class="checkout__item checkout__item--required" id="juridicShippingFirstNameParent">
								<input type="text" wire:model.defer="juridic_billing_first" name="juridicShippingFirstName" placeholder="@if (app()->has('label_order_firstname')){!! app('label_order_firstname') !!} @endif" autocomplete="given-name" required id="juridicShippingFirstName">
								<span></span>
							...
							<div class="checkout__item checkout__item--required" id="juridicShippingLastNameParent">
								<input type="text" wire:model.defer="juridic_billing_last" name="juridicShippingLastName" placeholder="@if (app()->has('label_order_lastname')){!! app('label_order_lastname') !!} @endif" autocomplete="family-name" required id="juridicShippingLastName">
								<span></span>
								<label for="juridicShippingLastName">@if (app()->has('label_order_lastname')){!! app('label_order_lastname') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div class="checkout__item checkout__item--required" id="juridicShippingPhoneParent">
								<input type="tel" wire:model.defer="juridic_billing_phone" name="juridicShippingPhone" placeholder="@if (app()->has('label_order_phone')){!! app('label_order_phone') !!} @endif" autocomplete="tel" pattern="[0-9]*" inputmode="numeric" required id="juridicShippingPhone">
								<span></span>
								<label for="juridicShippingPhone">@if (app()->has('label_order_phone')){!! app('label_order_phone') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div class="checkout__item checkout__item--required" id="juridicShippingEmailParent">
								<input type="email" wire:model.defer="juridic_billing_email" name="juridicShippingEmail" placeholder="@if (app()->has('label_order_email')){!! app('label_order_email') !!} @endif" autocomplete="email" required id="juridicShippingEmail">
								<span></span>
								<label for="juridicShippingEmail">@if (app()->has('label_order_email')){!! app('label_order_email') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div class="checkout__item checkout__item--required" id="companyNameParent">
								<input type="text" wire:model.defer="juridic_billing_company_name" name="companyName" placeholder="@if (app()->has('label_order_company_name')){!! app('label_order_company_name') !!} @endif" autocomplete="organization" required id="companyName">
								<span></span>
								<label for="companyName">@if (app()->has('label_order_company_name')){!! app('label_order_company_name') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div class="checkout__item checkout__item--required" id="registerCodeParent">
								<input type="text" wire:model.defer="juridic_billing_registration_code" name="registerCode" placeholder="@if (app()->has('label_order_register_code')){!! app('label_order_register_code') !!} @endif" autocomplete="off" required id="registerCode">
								<span></span>
								<label for="registerCode">@if (app()->has('label_order_register_code')){!! app('label_order_register_code') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div class="checkout__item checkout__item--required" id="registerNumberParent">
								<input type="text" wire:model.defer="juridic_billing_registration_number" name="registerNumber" placeholder="@if (app()->has('label_order_register_number')){!! app('label_order_register_number') !!} @endif" autocomplete="organization-number" required id="registerNumber">
								<span></span>
								<label for="registerNumber">@if (app()->has('label_order_register_number')){!! app('label_order_register_number') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div class="checkout__item" id="bankNameParent">
								<input type="text" wire:model.defer="juridic_billing_bank" name="bankName" placeholder="@if (app()->has('label_order_bankname')){!! app('label_order_bankname') !!} @endif" autocomplete="off" id="bankName">
								<span></span>
								<label for="bankName">@if (app()->has('label_order_bankname')){!! app('label_order_bankname') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div class="checkout__item" id="IBANParent">
								<input type="text" wire:model.defer="juridic_billing_account" name="IBAN" placeholder="@if (app()->has('label_order_iban')){!! app('label_order_iban') !!} @endif" autocomplete="IBAN" id="IBAN">
								<span></span>
								<label for="IBAN">@if (app()->has('label_order_iban')){!! app('label_order_iban') !!} @endif</label>
							</div>
						</div>
						<div wire:ignore class="checkout__form active">
							<div class="checkout__top">
							...
							<div class="checkout__item checkout__item--required" id="juridicShippingAddressParent">
								<input type="text" wire:model.defer="juridic_billing_address1" name="juridicShippingAddress" placeholder="@if (app()->has('label_order_address1')){!! app('label_order_address1') !!} @endif" autocomplete="street-address" required id="juridicShippingAddress">
								<span></span>
								<label for="juridicShippingAddress">@if (app()->has('label_order_address1')){!! app('label_order_address1') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div class="checkout__item" id="juridicShippingAddress2Parent">
								<input type="text" wire:model.defer="juridic_billing_address2" name="juridicShippingAddress2" placeholder="@if (app()->has('label_order_address2')){!! app('label_order_address2') !!} @endif" autocomplete="address-level2" id="juridicShippingAddress2">
								<span></span>
								<label for="juridicShippingAddress2">@if (app()->has('label_order_address2')){!! app('label_order_address2') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<select wire:model.defer="juridic_billing_country" class="select" id="juridic_billing_country" aria-label="select a country">
								<option value="Afghanistan">Afghanistan</option>
								<option value="Åland Islands">Åland Islands</option>
								<option value="Albania">Albania</option>
								<option value="Algeria">Algeria</option>
							...
							<div class="checkout__item checkout__item--required" id="juridicShippingCountyParent">
								<input type="text" wire:model.defer="juridic_billing_county" name="juridicShippingCounty" placeholder="@if (app()->has('label_order_county')){!! app('label_order_county') !!} @endif" autocomplete="county" required id="juridicShippingCounty">
								<span></span>
								<label for="juridicShippingCounty">@if (app()->has('label_order_county')){!! app('label_order_county') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div class="checkout__item checkout__item--required" id="juridicShippingCityParent">
								<input type="text" wire:model.defer="juridic_billing_city" name="juridicShippingCity" placeholder="@if (app()->has('label_order_city')){!! app('label_order_city') !!} @endif" autocomplete="off" required id="juridicShippingCity">
								<span></span>
								<label for="juridicShippingCity">@if (app()->has('label_order_city')){!! app('label_order_city') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div class="checkout__item checkout__item--required" id="juridicShippingPostalParent">
								<input type="text" wire:model.defer="juridic_billing_zipcode" name="juridicShippingPostal" placeholder="@if (app()->has('label_order_zipcode')){!! app('label_order_zipcode') !!} @endif" autocomplete="postal-code" required id="juridicShippingPostal">
								<span></span>
								<label for="juridicShippingPostal">@if (app()->has('label_order_zipcode')){!! app('label_order_zipcode') !!} @endif</label>
							</div>
						</div>
						<label class="checkout__checkbox">
						...
						<div class="checkout__form @if (!$juridic_identic && $juridic) active @endif">
							...
							<div wire:ignore class="checkout__item checkout__item--required" id="juridicBillingFirstNameParent">
								<input type="text" wire:model.defer="juridic_shipping_first" name="juridicBillingFirstName" placeholder="Prenume" autocomplete="given-name" required id="juridicBillingFirstName">
								<span></span>
							...
							<div wire:ignore class="checkout__item checkout__item--required" id="juridicBillingLastNameParent">
								<input type="text" wire:model.defer="juridic_shipping_last" name="juridicBillingLastName" placeholder="@if (app()->has('label_order_lastname')){!! app('label_order_lastname') !!} @endif" autocomplete="family-name" required id="juridicBillingLastName">
								<span></span>
								<label for="juridicBillingLastName">@if (app()->has('label_order_lastname')){!! app('label_order_lastname') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div wire:ignore class="checkout__item checkout__item--required" id="juridicBillingPhoneParent">
								<input type="tel" wire:model.defer="juridic_shipping_phone" name="juridicBillingPhone" placeholder="@if (app()->has('label_order_phone')){!! app('label_order_phone') !!} @endif" autocomplete="tel" pattern="[0-9]*" inputmode="numeric" required id="juridicBillingPhone">
								<span></span>
								<label for="juridicBillingPhone">@if (app()->has('label_order_phone')){!! app('label_order_phone') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div wire:ignore class="checkout__item checkout__item--required" id="juridicBillingEmailParent">
								<input type="email" wire:model.defer="juridic_shipping_email" name="juridicBillingEmail" placeholder="@if (app()->has('label_order_email')){!! app('label_order_email') !!} @endif" autocomplete="email" required id="juridicBillingEmail">
								<span></span>
								<label for="juridicBillingEmail">@if (app()->has('label_order_email')){!! app('label_order_email') !!} @endif</label>
							</div>
						</div>
						<!---------------------------------------------------->
						<div class="checkout__form @if (!$juridic_identic && $juridic) active @endif">
							...
							<div wire:ignore class="checkout__item checkout__item--required" id="juridicBillingAddressParent">
								<input type="text" wire:model.defer="juridic_shipping_address1" name="juridicBillingAddress" placeholder="@if (app()->has('label_order_address1')){!! app('label_order_address1') !!} @endif" autocomplete="street-address" required id="juridicBillingAddress">
								<span></span>
								<label for="juridicBillingAddress">@if (app()->has('label_order_address1')){!! app('label_order_address1') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div wire:ignore class="checkout__item" id="juridicBillingAddress2Parent">
								<input type="text" wire:model.defer="juridic_shipping_address2" name="juridicBillingAddress2" placeholder="@if (app()->has('label_order_address2')){!! app('label_order_address2') !!} @endif" autocomplete="address-level2" id="juridicBillingAddress2">
								<span></span>
								<label for="juridicBillingAddress2">@if (app()->has('label_order_address2')){!! app('label_order_address2') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<select wire:model.defer="juridic_shipping_country" class="select" id="juridic_shipping_country" aria-label="select a country">
								<option value="Afghanistan">Afghanistan</option>
								<option value="Åland Islands">Åland Islands</option>
								<option value="Albania">Albania</option>
								<option value="Algeria">Algeria</option>
							...
							<div wire:ignore class="checkout__item checkout__item--required" id="juridicBillingCountyParent">
								<input type="text" wire:model.defer="juridic_shipping_county" name="juridicBillingCounty" placeholder="@if (app()->has('label_order_county')){!! app('label_order_county') !!} @endif" autocomplete="county" required id="juridicBillingCounty">
								<span></span>
								<label for="juridicBillingCounty">@if (app()->has('label_order_county')){!! app('label_order_county') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div wire:ignore class="checkout__item checkout__item--required" id="juridicBillingCityParent">
								<input type="text" wire:model.defer="juridic_shipping_city" name="juridicBillingCity" placeholder="@if (app()->has('label_order_city')){!! app('label_order_city') !!} @endif" autocomplete="off" required id="juridicBillingCity">
								<span></span>
								<label for="juridicBillingCity">@if (app()->has('label_order_city')){!! app('label_order_city') !!} @endif</label>
							</div>
							<!---------------------------------------------------->
							<div wire:ignore class="checkout__item checkout__item--required" id="juridicBillingPostalParent">
								<input type="text" wire:model.defer="juridic_shipping_zipcode" name="juridicBillingPostal" placeholder="@if (app()->has('label_order_zipcode')){!! app('label_order_zipcode') !!} @endif" autocomplete="postal-code" required id="juridicBillingPostal">
								<span></span>
								<label for="juridicBillingPostal">@if (app()->has('label_order_zipcode')){!! app('label_order_zipcode') !!} @endif</label>
							</div>
						</div>
					</div>
					<div class="section__header">
						<h2 class="section__title">@if (app()->has('label_order_payment_method')){!! app('label_order_payment_method') !!} @endif</h2>
					</div>
					@if ($card["active"] != 0)
						<div class="payment">
							<label class="payment__wrapper" for="crd" wire:click="togglepayment('crd')">
								...
								<span>@if (app()->has('label_order_cart_stripe_title')){!! app('label_order_cart_stripe_title') !!} @endif</span>
							</label>
							<div class="payment__text @if ($crd) active @endif">
								<h3>@if (app()->has('label_order_cart_stripe_description')){!! app('label_order_cart_stripe_description') !!} @endif</h3>
							</div>
						</div>
					@endif
							<!---------------------------------------------------->
					@if ($cash["active"] != 0)
						<div class="payment">
							<label class="payment__wrapper" for="rtc" wire:click="togglepayment('rtc')">
								...
								<span>@if (app()->has('label_order_cash_title')){!! app('label_order_cash_title') !!} @endif</span>
							</label>
							<div class="payment__text @if ($rtc) active @endif">
								<h3>@if (app()->has('label_order_cash_description')){!! app('label_order_cash_description') !!} @endif</h3>
								@if (app()->has('global_cash_limit') && app('global_cash_limit') != 0)
								<span>@if (app()->has('label_order_cash_limit_text')){!! app('label_order_cash_limit_text') !!} @endif {{ app('global_cash_limit') }}</span>
								@endif
							</div>
						</div>
					@endif
						...
						@if ($juridic)
							<div class="payment">
								<label class="payment__wrapper" for="invoice" wire:click="togglepayment('invoice')">
									...
									<span>@if (app()->has('label_order_invoice_title')){!! app('label_order_invoice_title') !!} @endif</span>
								</label>
								<div class="payment__text @if ($invoice) active @endif">
									<h3>@if (app()->has('label_order_invoice_description')){!! app('label_order_invoice_description') !!} @endif</h3>
								</div>
							</div>
						@endif
					@endif
        ...
        items: dlvData.items
				...
				@if ($step == 2)
					...
					<div class="checkout__header" style="flex-direction: row !important">
						<button class="checkout__button" wire:click.prevent="previous()">
							...
							@if (app()->has('label_order_previous_step')){!! app('label_order_previous_step') !!} @endif
						</button>
						@if ($modification)
						<button class="checkout__button checkout__button--confirm item__button--disabled">
							@if (app()->has('label_order_confirm_step')){!! app('label_order_confirm_step') !!} @endif 
							<svg>
					...
					<div class="section__header">
						<h2 class="section__title">@if (app()->has('label_order_details_check')){!! app('label_order_details_check') !!} @endif</h2>
					</div>
					<div class="total__container">
						<!-------------- Individual information -------------->
						@if ($individual)
							<div class="look__form">
								<h3>@if (app()->has('label_order_billing_check')){!! app('label_order_billing_check') !!} @endif</h3>
								<span class="total__message">
									@if (app()->has('label_order_fullname')){!! app('label_order_fullname') !!} @endif:
									<strong>{{ $individual_billing_first }}</strong>
									<strong>{{ $individual_billing_last }}</strong>
								</span>
								<span class="total__message">
									@if (app()->has('label_order_phone')){!! app('label_order_phone') !!} @endif:
									<strong>{{ $individual_billing_phone }}</strong>
								</span>
								<span class="total__message">
									@if (app()->has('label_order_email')){!! app('label_order_email') !!} @endif:
									<strong>{{ $individual_billing_email }}</strong>
								</span>
								<span class="total__message">
									@if (app()->has('label_order_address1')){!! app('label_order_address1') !!} @endif:
									<strong>{{ $individual_billing_address1 }}</strong>
									<strong>{{ $individual_billing_address2 }}</strong>
								</span>
								<span class="total__message">
									@if (app()->has('label_order_country')){!! app('label_order_country') !!} @endif:
									<strong>{{ $individual_billing_country }}</strong>
								</span>
								<span class="total__message">
									@if (app()->has('label_order_county')){!! app('label_order_county') !!} @endif:
									<strong>{{ $individual_billing_county }}</strong>
								</span>
								<span class="total__message">
									@if (app()->has('label_order_city')){!! app('label_order_city') !!} @endif:
									<strong>{{ $individual_billing_city }}</strong>
								</span>
								<span class="total__message">
									@if (app()->has('label_order_zipcode')){!! app('label_order_zipcode') !!} @endif:
									<strong>{{ $individual_billing_zipcode }}</strong>
								</span>

								<h3>@if (app()->has('label_order_delivery_check')){!! app('label_order_delivery_check') !!} @endif</h3>
						...
						@else
							<div class="look__form">
								...
								<span class="total__message">
									@if (app()->has('label_order_company_name')){!! app('label_order_company_name') !!} @endif:
									<strong>{{ $juridic_billing_company_name }}</strong>
								</span>
								<span class="total__message">
									@if (app()->has('label_order_register_code')){!! app('label_order_register_code') !!} @endif:
									<strong>{{ $juridic_billing_registration_code }}</strong>
								</span>
								<span class="total__message">
									@if (app()->has('label_order_register_number')){!! app('label_order_register_number') !!} @endif:
									<strong>{{ $juridic_billing_registration_number }}</strong>
								</span>
								<span class="total__message">
									@if (app()->has('label_order_bankname')){!! app('label_order_bankname') !!} @endif:
									<strong>{{ $juridic_billing_bank }}</strong>
								</span>
								<span class="total__message">
									@if (app()->has('label_order_iban')){!! app('label_order_iban') !!} @endif:
								...
								<span class="total__message">@if (app()->has('label_order_county')){!! app('label_order_county') !!} @endif:
						...
						<div class="total__info">
							@if (!$cartItems->isEmpty())
								<?php $currency = $cartItems->first()->product->product_prices->first()->pricelist->currency->symbol; ?>
									...
									<div class="total__product">
										...
										@if ($nonquantity[$index])
											<div class="leftbar__link--text">
												...
												<span class="item__product--error">@if (app()->has('label_product_quantity_error')){!! app('label_product_quantity_error') !!} @endif {{ $cartItem->product->quantity }}</span>
												<a class="item__product--link" href="{{ url("/cart") }}">@if (app()->has('label_product_quantity_modify')){!! app('label_product_quantity_modify') !!} @endif</a>
											</div>
										@else
            								<a href="{{ route("product", ["product" => $cartItem->product->seo_id !== null && $cartItem->product->seo_id !== "" ? $cartItem->product->seo_id : $cartItem->product->id]) }}" target="_blank" class="total__name">{{ $cartItem->product->name }}</a>
										@endif
								...
								<div class="total__item">
									<span>@if (app()->has('label_order_payment_method')){!! app('label_order_payment_method') !!} @endif</span>
									<span>{{ $payment["description"] }}</span>
								</div>
								<div class="total__item">
									<span>@if (app()->has('label_cart_delivery_tag')){!! app('label_cart_delivery_tag') !!} @endif</span>
									<span>
								...
								@if ($cart->voucher && $cart->voucher_value > 0)
									<div class="total__item">
										<span>@if (app()->has('label_cart_voucher_tag')){!! app('label_cart_voucher_tag') !!} @endif</span>
										<span>
								...
								@endif
								<div class="total__item">
									<span>@if (app()->has('label_cart_total_tag')){!! app('label_cart_total_tag') !!} @endif</span>
									<span>{{ number_format($cart->final_amount, 2, ",", ".") }} {{ $currency }}
									</span>
								</div>
								@if ($modification)
								<span class="item__text--disabled">@if (app()->has('label_cart_order_error')){!! app('label_cart_order_error') !!} @endif</span>
								@endif
							@endif
						</div>
					</div>
				...
				@if ($step == 3)
					<section class="section__header container">
						...
						@if (app()->has('label_order_tag')){!! app('label_order_tag') !!} @endif {{ $new_order->order_number }}
						</h1>
					</section>

					<div class="section__header">
						<h2>@if (app()->has("label_order_default_text_confirmation")){!! app("label_order_default_text_confirmation") !!}@endif</h2>
					</div>
					<div class="total__container">
						<!------------- Order details --------------->
						<div class="look__form">
					...
					@if ($step == 2)
						<button class="checkout__button" wire:click.prevent="previous()" aria-label="go to previous step">
							<svg>
								<line x1="19" y1="12" x2="5" y2="12"></line>
								<polyline points="12 19 5 12 12 5"></polyline>
							</svg>@if (app()->has('label_order_previous_step')){!! app('label_order_previous_step') !!} @endif
						</button>
						@if ($modification)
						<button class="checkout__button checkout__button--confirm item__button--disabled">
							@if (app()->has('label_order_confirm_step')){!! app('label_order_confirm_step') !!} @endif 
