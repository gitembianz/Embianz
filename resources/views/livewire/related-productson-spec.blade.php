    ...
    <aside>
      ...
      <div class="aside aside--table @if ($addrelatedproducts) active @endif">
        ...
        <nav class="nav--controls">
          ...
          <button class="button button--secondary button--centered" wire:click.prevent="saveprod()">
            <svg>
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6 4h10l4 4v10a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2" />
              <path d="M12 14m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M14 4l0 4l-6 0l0 -4" />
            </svg>
        ...
        <label class="checkbox checkbox--secondary inline">
          ...
          <span></span>
                ...
                <td>
                  @if ($editedrow !== $index)
                    <div style="display: flex;">
                      <button class="button button--secondary button--sm" wire:click.prevent="editprod({{ $prod->id }}, {{ $prod->product->id }}, {{ $index }})">
                        <svg>
                  ...
                  @else
                    <div style="display: flex;">
                      <button class="button button--secondary button--sm" wire:click.prevent="confirmprod({{ $index }},{{ $prod->id }})">
                        <svg>
