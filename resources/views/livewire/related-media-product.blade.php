<div>
    ...
    <div class="accordion">
        ...
        {{-- external media --}}
        <div class="modal" id="externalmedia">
            <div class="modal-content">
                <h1 class="modal-content-title">
                    {{ __('Provide us the link of media') }}
                </h1>
                @for ($i = 1; $i <= $row; $i++)
                    <div class="display-f align-center">
                        ...
                        <div class="item__form-input">
                            <input type="url">
                            <span class="display-g">Media Path:</span>
                        </div>
                        <div class="item__form-input">
                            <select wire:model="file_locations.{{ $i }}">
                ...
                <input wire:click.prevent="externalsave" class="modal-content-btn submit" type="button" value="Save">
                <input class="modal-content-btn delete" type="button"
                    onclick="document.getElementById('externalmedia').style.display='none'" value="Cancel">

                <span class="modal-content-btn delete"
                    onclick="document.getElementById('externalmedia').style.display='none'">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewbox="0 0 24 24"
                        fill="none" stroke="#BBFCDE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <line x1="18" y1="6" x2="6" y2="18">
                        </line>
                            ...
                            @if ($this->showColumn('Name'))
                                <td data-title="Name">
                                    @if ($editedMediaIndex !== $index)
                                        <div class="cursor-p" wire:click.prevent="editMedia({{ $index }})">
                                            {{ $file->name }}</div>
                                    @else
