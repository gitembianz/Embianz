                            ...
                            <tbody>
                                @foreach ($medias as $media)
                                    <tr>
                                        ...
                                        <td><input type="number" placeholder="Media sequence" min="0" required
...
@if ($externalmedia)
    <form wire:submit.prevent="saveexternal">
        <div class="item">
            <input type="submit" id="add_media_related" class="item__form-btn item__form-long" value="Save Media">
            <table class="table-external">
                ...
                <tbody>
                    @for ($i = 1; $i <= $row; $i++)
                        <tr>
                            <td>
                                <input required type="text" wire:model="file_name.{{ $i }}">
                            </td>
                            <td>
        ...
        <div class="modal" id="confirmationmodalmedia">
            <div class="modal-content">
                ...
                <input class="modal-content-btn delete" type="button"
                    onclick="document.getElementById('confirmationmodalmedia').style.display='none'" value="Cancel">
