												...
												<tr>
													...
													<td class="wid-1">
														<div class="table__buttons">
															<button class="edit" wire:click.prevent="removemedia({{ $loop->index }})">
																<svg>
					...
					@if ($product->media->count() > 0)
						...
						<div class="modal" id="confirmationmodalmedia">
							<div class="modal-content">
								...
								<input class="modal-content-btn delete" type="button" onclick="document.getElementById('confirmationmodalmedia').style.display='none'" value="Cancel">
								<span class="modal-content-btn delete" onclick="document.getElementById('confirmationmodalmedia').style.display='none'">
									<svg>
										<line x1="18" y1="6" x2="6" y2="18">
										</line>
										<line x1="6" y1="6" x2="18" y2="18">
						...
						<div class="panel__header">
							...
							<div class="panel__header--bundle">
								...
								<div class="dropdown none" @if ($checked) style="display: unset; z-index: 5;" @endif>
									...
									@if ($checked && $all)
										<div class="dropdown-list" style="display: flex;">
											<button class="dropdown-item delete" type="button" wire:click="confirmFilesRemovalmultiple()">
												Delete
											</button>
										</div>
									@endif
											...
											<td data-title="Action">
												<div class="table__buttons">
													@if ($editedMediaIndex !== $index)
														...
														<button class="delete" wire:click.prevent="confirmRemoval({{ $file->id }})">
															<svg>
																<polyline points="3 6 5 6 21 6"></polyline>
																<path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2">
																</path>
