<section class="content">
  ...
  <nav class="nav--controls">
    ...
    {{-- Refresh Button --}}
    <a class="button button--secondary button--centered" tooltip="Back to Carts" tooltip-top href="{{ route('carts') }}">
      <svg><polyline points="15 18 9 12 15 6"></polyline></svg>
    </a>
    @if ($edititem === null)
      <button class="button button--secondary button--centered" tooltip="Edit this Cart" tooltip-left wire:click.prevent="edititem()">
    ...
    @else
      <button class="button button--secondary button--centered" tooltip="Save Edit" tooltip-left wire:click.prevent="savecart()">
      ...
      <button class="button button--secondary button--centered" tooltip="Cancel edit" tooltip-left wire:click.prevent="cancelcart()">
    ...
    @endif
    <button class="button button--secondary button--centered" tooltip="Delete this Cart" tooltip-left wire:click.prevent="confirmItemRemoval">
