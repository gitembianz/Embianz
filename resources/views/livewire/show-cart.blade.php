<section class="content">
    ...
    <nav class="nav--controls">
        ...
        {{-- Refresh Button --}}
        <a class="button button--primary button--centered" tooltip="Back to Carts" tooltip-top
            href="{{ route('carts') }}">
            <svg>
    ...
    <form style="height: calc(100% - 107.5px);" class="tabs__content details__view active" id="detailsContent">
        ...
        <div class="details__checkboxes ">
            ...
            <div class="input__tabs">
                <span class="disabled">{{ $cart->delivery_price_vat }}</span>
                <label for="category__name">Delivery Price VAT</label>
            </div>
        </div>
        ...
        {{-- Save Button --}}
        @if ($edititem != null)
            <button class="button button--fill button--secondary details__long" wire:click.prevent="savecart()"
                value="Save">
                Save
            </button>
        @endif
