<section class="content">
  ...
  <nav class="nav--controls">
    ...
    @if ($edititem === null)
      <button class="button button--primary button--centered" tooltip="Edit this Cart" tooltip-left wire:click.prevent="edititem()">
    ...
    @else
      <button class="button button--primary button--centered" tooltip="Save Edit" tooltip-left wire:click.prevent="savecart()">
      ...
      <button class="button button--primary button--centered" tooltip="Cancel edit" tooltip-left wire:click.prevent="cancelcart()">
    ...
    @endif
    <button class="button button--primary button--centered" tooltip="Delete this Cart" tooltip-left wire:click.prevent="confirmItemRemoval">
