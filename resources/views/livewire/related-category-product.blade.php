<div class="accordion @if ($showrelateitems) active @endif">
  {{-- ASIDES --}}
      ...
      <aside>
        <div class="background background--center @if ($linksingle || $linkmultiple) active @endif" style="z-index: 1100;"></div>
          ...
          <nav class="nav--controls" style="margin-top: 10px">
            ...
            @if ($selectPageadd || $selectAlladd || $checkedadd)
              <button class="button button--secondary button--centered"
                wire:click.prevent="confirmItemsLink()" tooltip="Link Multiple" tooltip-left>
                <svg>
