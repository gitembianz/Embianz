<div class="accordion @if ($showrelateitems) active @endif">
 ...
 <aside>
  <div class="background background--center @if ($linksingle || $linkmultiple) active @endif"></div>
  <div class="aside aside--confirm @if ($linksingle || $linkmultiple) active @endif">
   <span>
    @if ($linksingle)
 ...
 <aside>
  ...
  <div class="aside aside--table @if ($showTable) active @endif">
   ...
   <nav class="nav--controls" style="padding-top: 10px">
    ...
    @if ($selectPageadd || $selectAlladd || $checkedadd)
     <button tooltip="link multiple category" class="button button--secondary button--centered"
      wire:click.prevent="confirmItemsLink()">
      <svg>
   ...
   {{-- Tabel --}}
   <div class="table"@if ($selectPageadd || $selectAlladd) style="height: calc(100% - 150px);" @endif>
    <table class="expandable-table">
     <thead>
      <tr>
       ...
       <th>
        <button tooltip="link category" tooltip-top class="button button--secondary button--sm" style="opacity: 0">
         <svg>
