<section class="content">
 ...
 <nav class="nav--controls">
  ...
  <a href="{{ route('checkorders') }}" class="button button--primary button--centered display--desktop"
  ...
  <button class="button button--primary" tooltip="Filter by invoice date" tooltip-top wire:click="filter">
   <svg>
