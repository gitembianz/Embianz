<div class="accordion @if ($showrelateitems) active @endif">
                ...
                <table class="expandable-table">
                    ...
                    <tbody>
                        @php
                            $k = 0;
                        @endphp
                        @foreach ($competitorsAndValues as $index => $competitorsAndValue)
                            <tr class="expandable-row">
                                <td style="width: auto !important;" wire:click="expandRow2({{ $index }})">
                                    {{ $k }}
                                </td>
                                <td>
                                    @if ($competitorsAndValue['allow'])
                                                    ...
                                                    @if (count($competitors) >= 1)
                                                        @foreach ($competitors as $competitor)
                                                            <button class="item__searchable"
                                                                wire:click.prevent="selectitem({{ $index }}, {{ $competitor->id }}, '{{ $competitor->name }}')">
                                                                {{ $competitor->name }}
                                                            </button>
                                                        @endforeach
                                                    @else
                                    ...
                                    @else
                                        <div class="searchable">
                                            ...
                                            <button class="input__searchable">
                                                @if ($competitorsAndValue['itemselected'])
                                                    {{ $competitorsAndValue['itemselected'] }}
                                                @else
                                                    {{ __('Select a competitor') }}
                                                @endif
                                            </button>
                                            <button class="button__searchable"
                                    ...
                                    @endif
                                    <input type="hidden"
                                        wire:model.defer="competitorsAndValues.{{ $index }}.competitor.name">
                                </td>
                                <td class="hidden" wire:click="expandRow2({{ $index }})">
                                    <div class="searchable">
                                        <input type="text" required class="input__searchable"
                                            wire:model.defer="competitorsAndValues.{{ $index }}.name">
                                    </div>
                                </td>
                                <td class="hidden" wire:click="expandRow2({{ $index }})">
                                    <div class="searchable">
                                        <input type="number" min="0" step="0.01" required class="input__searchable"
                                            wire:model.defer="competitorsAndValues.{{ $index }}.price">
                                    </div>
                                </td>
                                <td class="hidden" wire:click="expandRow2({{ $index }})">
                                    <div class="searchable">
                                        <input type="text" required class="input__searchable"
                                            wire:model.defer="competitorsAndValues.{{ $index }}.url">
                                    </div>
                                </td>
                                ...
                                <td colspan="3">
                                    <div class="details">
                                      <p>
                                        ...
                                        <div class="searchable">
                                            <input type="text" required class="input__searchable"
                                                wire:model.defer="competitorsAndValue.{{ $index }}.name">
                                        </div>
                                        </p>
                                        <p>
                                            <bold>Price</bold>
                                        <div class="searchable">
                                            <input type="text" required class="input__searchable"
                                                wire:model.defer="competitorsAndValue.{{ $index }}.price">
                                        </div>
                                        </p>
                                        <p>
                                            <bold>Url</bold>
                                        <div class="searchable">
                                            <input type="text" required class="input__searchable"
                                                wire:model.defer="competitorsAndValue.{{ $index }}.url">
                                        </div>
                                        </p>
                                    </div>
                                </td>
    ...
    <div class="accordion__header">
        <button
            ...
            {{ __('Competitors ') }}({{ $relatedcompetitors->total() }})
            <svg>
    ...
    <div class="accordion__body">
        ...
        {{-- Load More --}}
        @if ($loadAmount < $relatedcompetitors->total())
