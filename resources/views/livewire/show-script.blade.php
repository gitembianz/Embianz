<section class="content">
  ...
  <nav class="nav--controls">
    ...
    {{-- Refresh Button --}}
    <a class="button button--secondary button--centered" tooltip="Back to Custom scripts" tooltip-top href="{{ route('customscripts') }}">
      <svg><polyline points="15 18 9 12 15 6"></polyline></svg>
    </a>
    <a class="button button--secondary button--centered" tooltip="Create new script" tooltip-top href="{{ route('new_script') }}">
    ...
    @if ($edititem === null)
      <button class="button button--secondary button--centered" tooltip="Edit this script" tooltip-left wire:click.prevent="edititem()">
    ...
    @else
      ...
      <button class="button button--secondary button--centered" tooltip="Cancel edit" tooltip-left wire:click.prevent="cancelitem()">
    ...
    @endif
    <button class="button button--secondary button--centered" tooltip="Delete this script" tooltip-left wire:click.prevent="confirmItemRemoval({{ $script->id }})">
