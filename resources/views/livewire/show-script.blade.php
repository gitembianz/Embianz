<section class="content">
  ...
  <nav class="nav--controls">
    ...
    <a class="button button--secondary button--centered" href="{{ route('new_script') }}">
    ...
    @endif
    <button class="button button--secondary button--centered" wire:click.prevent="confirmItemRemoval({{ $script->id }})">
