<div>
                  ...
                  @foreach ($cartItems as $index => $cartItem)
                      ...
                      <div class="basket__split">
                          <a class="basket__item" href="{{ route('product', ['product' => $cartItem->product->seo_id !== null && $cartItem->product->seo_id !== '' ? $cartItem->product->seo_id : $cartItem->product->id]) }}">
                              ...
                              <button class="basket__delete" aria-label="Remove from cart button" wire:click="removeFromCart({{ $cartItem->product->id }})" onclick="removeItem(this)">
                                  <svg>
                          ...
                          <div class="basket__item">
                              <div class="quantity">
                                  ...
                                  <div class="quantity__buttons">
                                      ...
                                      <button
                                          class="quantity__arrow @if ($cartItem->quantity >= $cartItem->product->quantity) disabled @endif"
              ...
              <div class="details">
                  ...
                  <div class="details__content">
                      ...
                      @if (!$aplicabble_voucher)
                          ...
                          @else
                              <button id="detailsContinue" class="details__button details__continue"
                                  wire:click="continue()" aria-label="Continue form">Continuă</button>
                          @endif
                      @endif
  ...
  <div class="dlv" style="display: none">
    <span class="dlv_currency">{{ $currency = $cartItem->product->product_prices->first()->pricelist->currency->name; }}</span>
