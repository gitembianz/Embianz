                     ...
                     <div class="cart-page--text">
                         ...
                         <div class="cart-page--bundle">
                             <div class="product__count">
                                 <button wire:click="decrement({{ $product->id }})" id="countDecrease">
                                     <svg>
                                         <line x1="5" y1="12" x2="19" y2="12"></line>
                                     </svg>
                                 </button>
                                 <input type="number" name="count" id="count" min="1"
                                     value="{{ $product->carts->first()->quantity }}">
                                 <button wire:click="increment({{ $product->id }})" id="countIncrease">
                                     <svg>
                             ...
                             <button class="cart-page__delete" wire:click="removeFromCart({{ $product->id }})">
                                 <svg>
