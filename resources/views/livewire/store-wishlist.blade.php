				...
				@foreach ($wishlistitems as $product)
					<div class="basket__product">
						<div class="basket__top">
							...
							@endif
							<div>
								<a href="{{ route("product", ["product" => $product->seo_id !== null && $product->seo_id !== "" ? $product->seo_id : $product->id]) }}" class="basket__title">{{ $product->name }}</a>
							...
							<button class="basket__delete" wire:click="removeFromWishlist({{ $product->id }})" aria-label="Remove from wishlist">
								<svg>
