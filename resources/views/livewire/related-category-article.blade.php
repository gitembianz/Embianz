<div class="accordion @if ($showrelateitems) active @endif">
                ...
                <table class="expandable-table">
                    ...
                    <tbody>
                        @php
                            $k = 0;
                        @endphp
                        @foreach ($articlesAndValues as $index => $articlesAndValue)
                            <tr class="expandable-row">
                                ...
                                <td wire:click="expandRow2({{ $index }})">
                                    {{ $articlesAndValue['itemselected'] }}
                                </td>
                                <td class="hidden">
                                    @if ($articlesAndValue['allow'])
                                    ...
                                    @else
                                        <div class="searchable">
                                            ...
                                            <button class="input__searchable">
                                                @if ($articlesAndValue['itemselected'])
                                                    {{ $articlesAndValue['itemselected'] }}
                                                @else
                                    ...
                                    @endif
                                    <input type="hidden"
                                        wire:model.defer="articlesAndValues.{{ $index }}.product.name">
                                </td>

                                <td class="hidden" data-title="Check">
                                    <div class="checkbox--primary">
                                        <input type="checkbox" id="{{ $index }}pri"
                                            wire:model.defer="articlesAndValues.{{ $index }}.product.primary">
    ...
    <div class="accordion__header">
        <button
            ...
            {{ __('Article Categories ') }}({{ $relatedcats->total() }})
            <svg>
