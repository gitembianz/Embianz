<section class="content">
  ...
  <nav class="nav--controls">
    ...
    {{-- Refresh Button --}}
    <a class="button button--secondary button--centered" href="{{ url('/products') }}">
    ...
    @if ($editproduct === null)
      <button class="button button--secondary button--centered" wire:click.prevent="editproduct()">
    ...
    @else
      <button class="button button--secondary button--centered" wire:click.prevent="saveproduct()">
      ...
      <button class="button button--secondary button--centered" wire:click.prevent="cancelproduct()">
    ...
    @endif
    <button class="button button--secondary button--centered" wire:click.prevent="confirmProductRemoval({{ $product->id }})">
  ...
  <form style="height: calc(100% - 107.5px);" class="tabs__content details__view active" id="detailsContent">
    ...
    {{-- Save Button --}}
    @if ($editproduct != null)
      <button class="button button--fill button--secondary details__long" wire:click.prevent="saveproduct()" value="Save">
        Save
      </button>
    @endif
  </form>
