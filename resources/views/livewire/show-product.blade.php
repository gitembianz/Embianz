<section class="content">
    ...
    {{-- Tabs Body (Details) --}}
    <form style="height: calc(100% - 107.5px); padding-bottom:15px" class="tabs__content details__view active" id="detailsContent">
        {{-- Product Name --}}
            ...
            <div class="checkbox__details">
                @if ($editproduct === null)
                    @if ($product->is_digital)
                        <input type="checkbox" id="isDigital1" checked class="disabled" disabled />
                        <label for="isDigital1" class="disabled">Is Digital</label>
                    @else
                        <input type="checkbox" id="isDigital2" class="disabled" disabled />
                        <label for="isDigital2" class="disabled">Is Digital</label>
                    @endif
                @else
                    <input type="checkbox" id="isDigital3" wire:model.defer="prod.is_digital" />
                    <label for="isDigital3">Is Digital</label>
                @endif
            </div>
        </div>
        <div class="details__checkboxes">
        ...
        <div class="input__tabs">
            ...
            @else
                <input type="text" placeholder=" " name="product__name" wire:model.defer="prod.google_category"
                    required>
            @endif
