<section class="content">
  ...
  {{-- Navigation --}}
  <h1 class="table--name">{{ __('Labels') }} ({{ $labels->count() }})</h1>
      ...
      <tbody>
        ...
        @foreach ($labels as $index => $label)
          <tr class="expandable-row">
            ...
            <td>
              @if ($rowindex !== $index)
              <button class="button button--secondary button--sm" wire:click.prevent="edititem({{ $index }}, {{ $label->id }})">
                <svg>
              ...
              @else
                <div style="display: flex;">
                  <button class="button button--secondary button--sm" wire:click.prevent="saveitem({{ $index }} , {{ $label->id }})">
                    <svg>
                    <polyline points="20 6 9 17 4 12"></polyline>
                    </svg>
                  </button>
