        ...
        <thead>
            <tr>
                ...
                @if ($this->showColumn('Active'))
                    <th>
                        <button class="table__header--btn"
                            @if ($orderBy === 'active' && $orderAsc === '1') data-symbol="up" @else data-symbol="down" @endif
                    ...
                    <tr class="@if ($this->isChecked($payment->id)) table__row--selected @endif">
                        ...
                        <td data-title="Action" class="table__buttons">
                            <div class="table__buttons">
                                @if ($editeindex !== $index)
                                    <button class="edit"
                                        wire:click.prevent="edit({{ $index }}, {{ $payment->id }})">
                                        <svg>
                                    ...
                                    <button class="delete"
                                        wire:click.prevent="confirmItemRemoval({{ $payment->id }})">
                                        <svg>
                                ...
                                @else
                                    <button class="edit"
                                        wire:click.prevent="save({{ $index }} , {{ $payment->id }})">
                                        <svg>
