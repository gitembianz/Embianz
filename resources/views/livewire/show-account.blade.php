<section class="content">
  ...
  <nav class="nav--controls">
    ...
    {{-- Refresh Button --}}
    <a class="button button--secondary button--centered" tooltip="Back to Accounts" tooltip-top href="{{ route('accounts') }}">
      <svg><polyline points="15 18 9 12 15 6"></polyline></svg>
    </a>
    @if ($edititem === null)
      <button class="button button--secondary button--centered" tooltip="Edit this Account" tooltip-left wire:click.prevent="edititem()">
    ...
    @endif
    <button class="button button--secondary button--centered" tooltip="Delete this Account" tooltip-left wire:click.prevent="confirmItemRemoval">
  ...
  <form style="height: calc(100% - 107.5px);" class="tabs__content details__view active" id="detailsContent">
    ...
    {{-- Save Button --}}
    @if ($edititem != null)
      <button class="button button--fill button--secondary details__long" wire:click.prevent="saveaccount()" value="Save">
        Save
      </button>
    @endif
  </form>
