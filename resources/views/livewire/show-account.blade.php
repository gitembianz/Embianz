        ...
        <div class="item__header-buttons">
            ...
            @if ($edititem === null)
                <button class="item__header-btn" type="button" value="Edit" wire:click.prevent="edititem()"
                    data-tooltip-center="Edit this account">
                    <svg>
            ...
            <button wire:click.prevent="confirmItemRemoval" class="item__header-btn delete" type="button"
                value="Delete" data-tooltip-right="Delete this account">
                <svg>
        ...
        <div class="tab__list">
            <div class="tabs__content active" id="Details">
                <div class="item__form">
                    ...
                    @if ($edititem != null)
                        <button class="item__form-btn item__form-long" wire:click.prevent="saveaccount()"
                            value="Save">
                            Save
                        </button>
                    @endif
