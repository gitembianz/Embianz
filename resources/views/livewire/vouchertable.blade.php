<section class="content">
  ...
  {{-- Navigation --}}
  <h1 class="table--name">{{ __('Vouchers') }} ({{ $vouchers->count() }})</h1>
      ...
      <tbody>
        ...
        @endphp
          @foreach ($vouchers as $nr => $voucher)
            <tr @if ($loop->last) id="last_record" @endif class="expandable-row @if ($this->isChecked($voucher->id)) active @endif">
              ...
              <td style="border-right: none">
                ...
                @if ($editindex !== $nr)
                  <button class="button button--secondary button--sm" wire:click.prevent="edititem({{ $nr }}, {{ $voucher->id }})">
                  <svg>
                    <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z">
                    </path>
                  </svg>
                  </button>
                  <button class="button button--secondary button--sm" wire:click.prevent="confirmItemRemoval({{ $voucher->id }})">
                  <svg>
                    <polyline points="3 6 5 6 21 6"></polyline>
                ...
                @else
                  <button class="button button--secondary button--sm" wire:click.prevent="saveitem({{ $nr }} , {{ $voucher->id }})">
                    <svg>
