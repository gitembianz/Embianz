<div class="content">
  ...
  {{-- Navigation --}}
  <h1 class="table--name">{{ __('Price Lists') }} ({{ $pricelists->count() }})</h1>
  <nav class="nav--controls">
    ...
    {{-- Add Price --}}
    <a class="button button--secondary button--centered display--desktop" href="{{ route('new_pricelist') }}">
      <svg>
    ...
    <div class="dropdown dropdown--right display--mobile" id="optional__dropdown">
      ...
      <div class="dropdown__content">
        <div class="dropdown__container">
          ...
          <a class="button button--primary button--long button--flexed" href="{{ route('new_pricelist') }}">
            <svg>
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
              <polyline points="14 2 14 8 20 8"></polyline>
              <line x1="12" y1="18" x2="12" y2="12"></line>
      ...
      <tbody>
        ...
        @else
          @foreach ($pricelists as $nr => $price)
            <tr @if ($loop->last) id="last_record" @endif class="expandable-row @if ($this->isChecked($price->id)) active @endif"  >
              ...
              <td style="border-right: none">
                <button wire:click.prevent="confirmItemRemoval({{ $price->id }})" class="button button--secondary button--sm">
                  <svg>
                    <polyline points="3 6 5 6 21 6"></polyline>
                    <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                  </svg>
