<section class="content">
 ...
 <nav class="nav--controls">
  ...
  {{-- Refresh Button --}}
  <a class="button button--secondary button--centered" tooltip="Back to all specifications" tooltip-top
   href="{{ route('specs') }}">
   <svg>
    <polyline points="15 18 9 12 15 6"></polyline>
   </svg>
  </a>
  <a class="button button--secondary button--centered" tooltip="Create new specification" tooltip-top
   href="{{ route('new_spec') }}">
   <svg>
  ...
  @if ($edititem === null)
   <button class="button button--secondary button--centered" tooltip="Edit this specification" tooltip-left
  ...
  @endif
  <button class="button button--secondary button--centered" tooltip="Delete this specification" tooltip-left
