<div class="content">
  ...
  <nav class="nav--controls">
    ...
    {{-- Refresh Button --}}
    <a class="button button--secondary button--centered" href="{{ route('specs') }}">
      <svg><polyline points="15 18 9 12 15 6"></polyline></svg>
    </a>
    <a class="button button--secondary button--centered" href="{{ route('new_spec') }}">
    ...
    @endif
    <button class="button button--secondary button--centered" wire:click.prevent="confirmItemRemoval({{ $spec->id }})">
