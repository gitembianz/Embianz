<section class="content">
  ...
  <nav class="nav--controls">
    ...
    <a class="button button--secondary button--centered" tooltip="Create new specification" tooltip-top href="{{ route('new_spec') }}">
    ...
    @if ($edititem === null)
      <button class="button button--secondary button--centered" tooltip="Edit this specification" tooltip-left wire:click.prevent="edititem()">
    ...
    @endif
    <button class="button button--secondary button--centered" tooltip="Delete this specification" tooltip-left wire:click.prevent="confirmItemRemoval({{ $spec->id }})">
