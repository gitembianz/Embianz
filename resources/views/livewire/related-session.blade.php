                            ...
                            @foreach ($selectedColumns as $column)
                                ...
                                <td @if ($index > 1) class="hidden" @endif
                                    ...
                                    @elseif ($column === 'name' && $relatedby === 'carts')
                                        <a
                                            href="{{ route('show_cart', ['id' => $related->id]) }}">{{ $related->name }}</a>
                                    @elseif ($column === 'name' && $relatedby === 'orders')
                                        <a
                                            href="{{ route('show_order', ['id' => $related->id]) }}">{{ $related->name }}</a>
                                    @elseif ($column === 'product_id' && $relatedby === 'wishlist')
                                        <a
                                            href="{{ route('show_product', ['id' => $related->id]) }}">{{ $related->product->name }}</a>
