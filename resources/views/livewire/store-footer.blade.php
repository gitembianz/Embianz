                ...
                <div class="footer__top">
                    <a class="logo" href="{{ url('/') }}">
                        <img title="{{ app('global_site_name') }} logo" loading="eager"
                            src="/images/store/svg/ogo-light.svg" alt="logo">
                    </a>
                ...
                <div class="footer__middle">
                    ...
                    <form class="subscribe" wire:submit.prevent="store">
                        <input type="email" id="subscribeInput" wire:model="email" name="email" id="email"
                            placeholder="@if (app()->has('label_newsletter_subscribe_placeholder')) {!! app('label_newsletter_subscribe_placeholder') !!} @endif"
