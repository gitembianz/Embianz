<section class="content">
  ...
  <nav class="nav--controls">
    ...
    {{-- Refresh Button --}}
    <a class="button button--secondary button--centered" href="{{ route('pricelists') }}">
      <svg><polyline points="15 18 9 12 15 6"></polyline></svg>
    </a>
    <a class="button button--secondary button--centered" href="{{ route('new_pricelist') }}">
    ...
    @else
      ...
      <button class="button button--secondary button--centered" wire:click.prevent="cancelitem()">
    ...
    @endif
    <button class="button button--secondary button--centered" wire:click.prevent="confirmItemRemoval({{ $pricelist->id }})">
