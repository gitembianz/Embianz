<section class="content">
  ...
  <nav class="nav--controls">
    ...
    {{-- Refresh Button --}}
    <a class="button button--secondary button--centered" tooltip="Back to Price List" tooltip-top href="{{ route('pricelists') }}">
      <svg><polyline points="15 18 9 12 15 6"></polyline></svg>
    </a>
    <a class="button button--secondary button--centered" tooltip="Create new Price" tooltip-top href="{{ route('new_pricelist') }}">
    ...
    @if ($edititem === null)
      <button class="button button--secondary button--centered" tooltip="Edit this Price" tooltip-left wire:click.prevent="edititem()">
    ...
    @endif
    <button class="button button--secondary button--centered" tooltip="Delete this Price" tooltip-left wire:click.prevent="confirmItemRemoval({{ $pricelist->id }})">
