<div>
    ...
    <div class="item__header">
        ...
        <div class="item__header-buttons">
            <a class="item__header-btn" href="{{ route('pricelists') }}" data-tooltip-left="Back to all pricelists">
                <svg>
                    <polyline points="11 17 6 12 11 7"></polyline>
                    <polyline points="18 17 13 12 18 7"></polyline>
                </svg>
            </a>
            <a class="item__header-btn" href="{{ route('newpricelist') }}" data-tooltip-center="Create a new Pricelist">
                <svg>
            ...
            @if ($edititem === null)
                <button class="item__header-btn" type="button" value="Edit" wire:click.prevent="edititem()"
                    data-tooltip-center="Edit this Pricelist">
                    <svg>
        ...
        <div class="tab__list">
            <div class="tabs__content active" id="Details">
                <div class="item__form">
                    ...
                    @else
                        <select wire:model.defer="record.currency" class="item__form-input">
