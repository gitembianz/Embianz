<div class="accordion @if ($showmedia) active @endif">
    <div class="accordion__header">
        ...
        <button tooltip="Add media" tooltip-left class="button button--secondary" wire:click.prevent="uploadmedia()">
            <svg>
    ...
    <aside>
        ...
        <div class="aside aside--confirm @if ($chose == true) active @endif">
            ...
            <input style="display: none;" id="localMedia" wire:model="medias" type="file" accept="image/*,video/*"
                multiple>
    ...
    <aside>
        ...
        <form class="aside aside--table @if ($medias) active @endif"
            wire:submit.prevent="savelocal">
            {{-- Navigation --}}
            <nav class="nav--controls">
                <h1 class="table--name">
                    {{ __('Add local media') }}
                </h1>
                <button tooltip="Save media" tooltip-left class="button button--primary button--centered" value="submit"
                    type="submit">
                    <svg>
                ...
                <button tooltip="Cancel" tooltip-left class="button button--danger button--centered"
                    wire:click="cancel()">
                    <svg>
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <table class="expandable-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 30% !important" class="hidden">
                                <div class="table--btn">Name</div>
                            </th>
                            <th style="width: 10% !important" class="hidden">
                                <div class="table--btn">Size</div>
                            </th>
                            <th style="width: 10% !important" class="hidden">
                                <div class="table--btn">Extension Type</div>
                            </th>
                            <th style="width: 20% !important" class="hidden">
                    ...
                    <tbody>
                        ...
                        @foreach ($medias as $index => $media)
                            <tr class="expandable-row">
                                ...
                                <td>
                                    <button tooltip="Remove" tooltip-left class="button button--secondary button--sm"
                    ...
                    <tbody>
                        ...
                        @for ($i = 0; $i <= $row; $i++)
                            <tr class="expandable-row">
                                ...
                                <td>
                                    <div class="searchable">
                                        <input placeholder="Ex: 1,2,3.." type="number" min="0"
                                ...
                                <td class="hidden">
                                    <div class="searchable">
                                        <input placeholder="Media external link" type="url"
                                            class="input__searchable" wire:model="file_link.{{ $i }}">
                                    </div>
                                </td>
                                <td>
            ...
            <table class="expandable-table">
                ...
                <tbody>
                    ...
                    @if ($filteredMedia->isEmpty())
                        <tr>
                            <td class="table--empty" colspan="{{ count($selectedColumns) + 2 }}">No record found.
                            </td>
                        </tr>
                    @else
