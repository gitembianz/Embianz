        ...
        @if ($showrelatedsub)
            <div class="accordion__content">
                <div class="item">
                    ...
                    @if ($showTable === false)
                    @else
                        <button class="item__upload-btn" wire:click="cancel">{{ __('Cancel and Save all') }}</button>
                        ...
                        data-symbol="down" @endif
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr class="@if ($this->isCheckedadd($category->id)) th_checked @endif">
                                        <td data-title="Check"><input type="checkbox" value="{{ $category->id }}"
                                        ...
                                        @endif
                                        @if ($this->showColumnadd('Short Description'))
                                            <td data-title="Short Description">{{ $category->short_description }}
                                            </td>
                                        @endif
                                        @if ($this->showColumnadd('Created At'))
                          ...
                          @else
                            ...
                            <tbody>
                                @foreach ($relatedsubcats as $subcat)
                                    <tr class="@if ($this->isChecked($subcat->id)) th_checked @endif">
                                        <td data-title="Check"><input type="checkbox" value="{{ $subcat->id }}"
                                                wire:model="checked">
                                        </td>
                                        ...
                                        @endif
                                        @if ($this->showColumn('Created At'))
                                            <td data-title="Created At">{{ $subcat->parrent->created_at }}</td>
                                        @endif
