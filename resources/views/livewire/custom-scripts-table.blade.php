<section class="content">
 ...
 {{-- Navigation --}}
 <h1 class="table--name">{{ __('Custom Scripts') }} ({{ $customscripts->total() }})</h1>
 <nav class="nav--controls">
  ...
  {{-- Add custom script --}}
  <a class="button button--secondary button--centered display--desktop" tooltip="Add new custom script" tooltip-top
