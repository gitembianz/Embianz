<section class="content">
  ...
  {{-- Navigation --}}
  <h1 class="table--name">{{ __('Custom Scripts') }} ({{ $customscripts->count() }})</h1>
  <nav class="nav--controls">
    ...
    {{-- Add custom script --}}
    <a class="button button--secondary button--centered display--desktop" tooltip="Add new specification" tooltip-top href="{{ route('new_script') }}">
      <svg>
    ...
    <div class="dropdown dropdown--right display--mobile" id="optional__dropdown">
      ...
      <div class="dropdown__content">
        <div class="dropdown__container">
          ...
          <button class="button button--primary button--fill button--flexed" href="{{ route('new_script') }}">
            <svg>
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
              <polyline points="14 2 14 8 20 8"></polyline>
              <line x1="12" y1="18" x2="12" y2="12"></line>
  ...
  <div class="table" @if ($selectPage || $selectAll) style="height: calc(100% - 150px);" @endif>
    ...
    {{-- Load More Manual --}}
    @if ($loadAmount <= count($customscripts))
