<div class="content">
  ...
  <nav class="nav--controls">
    ...
    <a class="button button--secondary button--centered" href="{{ route('newcategory') }}">
    ...
    @if ($editcategory === null)
      <button class="button button--secondary button--centered" wire:click.prevent="editcategory()">
    ...
    @else
      <button class="button button--secondary button--centered" wire:click.prevent="savecategory()">
      ...
      <button class="button button--secondary button--centered" wire:click.prevent="cancelcategory()">
    ...
    @endif
    <button class="button button--secondary button--centered" wire:click.prevent="confirmItemRemoval({{ $category->id }})">
