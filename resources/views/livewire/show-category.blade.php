<div>
    ...
    <div class="item__header">
        ...
        <div class="item__header-buttons">
            ...
            @else
                <button class="item__header-btn edit" type="button" wire:click.prevent="savecategory()" value="Save"
                ...
                <button class="item__header-btn edit" type="button" wire:click.prevent="cancelcategory()"
                    value="Cancel" data-tooltip-center="Cancel this changes">Cancel</button>
            @endif
