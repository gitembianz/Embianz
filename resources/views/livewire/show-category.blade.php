<section class="content">
  ...
  <nav class="nav--controls">
    ...
    {{-- Refresh Button --}}
    <a class="button button--secondary button--centered" tooltip="Back to Carts" tooltip-top  href="{{ route('category') }}">
      <svg><polyline points="15 18 9 12 15 6"></polyline></svg>
    </a>
    <a class="button button--secondary button--centered" tooltip="Create new category" tooltip-top  href="{{ route('newcategory') }}">
    ...
    @if ($editcategory === null)
      <button class="button button--secondary button--centered" tooltip="Edit this category" tooltip-left  wire:click.prevent="editcategory()">
    ...
    @else
      <button class="button button--secondary button--centered" tooltip="Save Edit" tooltip-left  wire:click.prevent="savecategory()">
      ...
      <button class="button button--secondary button--centered" tooltip="Cancel edit" tooltip-left  wire:click.prevent="cancelcategory()">
    ...
    @endif
    <button class="button button--secondary button--centered" tooltip="Delete this category" tooltip-left  wire:click.prevent="confirmItemRemoval({{ $category->id }})">
  ...
  <form style="height: calc(100% - 107.5px);" class="tabs__content details__view active" id="detailsContent">
    ...
    {{-- Save Button --}}
    @if ($editcategory != null)
      <button class="button button--fill button--secondary details__long" wire:click.prevent="savecategory()" value="Save">
        Save
      </button>
    @endif
  </form>
