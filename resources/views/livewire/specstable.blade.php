<section class="content">
 ...
 {{-- Navigation --}}
 <h1 class="table--name">{{ __('Specifications') }} ({{ $specs->total() }})</h1>
 <nav class="nav--controls">
  ...
  {{-- Add specification --}}
  <a class="button button--secondary button--centered display--desktop" tooltip="Add new specification" tooltip-top
   href="{{ route('new_spec') }}">
   <svg>
