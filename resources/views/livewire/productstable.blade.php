<div class="content">
  ...
  {{-- Navigation --}}
  <h1 class="table--name">{{ __('Products') }} ({{ $products->count() }})</h1>
  <nav class="nav--controls">
    ...
    {{-- Add Product --}}
    <a class="button button--secondary button--centered display--desktop" href="{{ route('add_product') }}">
      <svg>
    ...
    <div class="dropdown dropdown--right display--mobile" id="optional__dropdown">
      ...
      <div class="dropdown__content">
        <div class="dropdown__container">
          ...
          <a class="button button--primary button--long button--flexed" href="{{ route('add_product') }}">
            <svg>
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
              <polyline points="14 2 14 8 20 8"></polyline>
              <line x1="12" y1="18" x2="12" y2="12"></line>
      ...
      <tbody>
        ...
        @endphp
          @foreach ($products as $nr => $product)
            <tr @if ($loop->last) id="last_record" @endif class="expandable-row @if ($this->isChecked($product->id)) active @endif"  >
              ...
              @foreach ($selectedColumns as $index => $column)
                <td @if ($index > count($selectedColumns) - 18) class="hidden" @endif data-title="{{ $column }}" wire:click="expandRow({{ $nr }})">
                  @if ($column === "name")
              ...
              <td style="border-right: none">
                <button wire:click.prevent="confirmItemRemoval({{ $product->id }})" class="button button--secondary button--sm">
                  <svg>
                    <polyline points="3 6 5 6 21 6"></polyline>
                    <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                  </svg>
